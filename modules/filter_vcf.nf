process filter_vcf {
    ...
    script:
        ...
        bcftools view -H ${vcf} >> ${meta.id}.header_modified.vcf
        ...
        bcftools view -f 'PASS' -g 'het' --exclude 'ALT="N"' --exclude-types indels ${meta.id}.only_pop.vcf.gz chr1 chr2 chr3 chr4 chr5 chr6 chr7 chr8 chr9 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19 chr20 chr21 chr22 chrX chrY | bedtools intersect -header -a - -b ${params.cpgs_bed} -wa -v > ${meta.id}.filtered.vcf
